...
<head>
    ...
    <title>View Stock Inward - <?=GLOBAL_TITLE;?></title>
                                ...
                                <div class="card-header">
                                    <div class="row">
                                        <div class="col-lg-8 col-sm-8 col-12">
                                            <h5>View Stock Inward
                                            </h5>
                                        </div>
                                        <div class="col-lg-4 col-sm-4 col-12">
                                            <ul class="bottom-buttons top">
                                                <li><a href="admin/2-stock-inward-list.php"><button
                                                            class="btn btn-sm btn-light" type="button">Back</button></a>
                                                    <a href="javascript:void(0);"><button
                                                            class="btn btn-sm btn-success" type="button">Confirm</button></a>
                                                    <a href="admin/2-stock-inward-edit.php"><button
                                                            class="btn btn-sm btn-warning" type="button">Edit</button></a>              
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
