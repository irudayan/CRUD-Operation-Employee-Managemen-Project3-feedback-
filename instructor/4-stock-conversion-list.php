...
<head>
    ...
    <title>Stock Conversion - <?=GLOBAL_TITLE;?></title>
                                    ...
                                    <div class="card-header">
                                        <div class="row">
                                            <div class="col-lg-10 col-sm-10 col-xs-12">
                                                ...
                                                <h5>Stock Conversion </h5>
                                            </div>
                                            <div class="col-lg-2 col-sm-2 col-12">
                                                <a href="admin/4-stock-conversion-add.php" class="btn btn-sm btn-info"
                                        ...
                                        <table class="table table-responsive-sm table-bordered table-striped table-sm"
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>Admin</td>
                                                    <td>
                                                        <a href="admin/4-stock-conversion-view.php"><i
                                                                class="c-icon c-icon-1xl mb-2 cil-search"></i></a>
                                                        &nbsp;
                                                        <a href="admin/4-stock-conversion-edit.php"><i
