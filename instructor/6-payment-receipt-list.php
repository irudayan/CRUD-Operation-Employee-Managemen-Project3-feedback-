...
<head>
    ...
    <title>Payment Receipt - <?=GLOBAL_TITLE;?></title>
                                    ...
                                    <div class="card-header">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-2 col-sm-2 col-12">
                                                <a href="admin/6-payment-receipt-add.php" class="btn btn-sm btn-info" style="float:right;">Add
                                                </a> 
                                        ...
                                        <table class="table table-responsive-sm table-bordered table-striped table-sm"
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>20,000</td>
                                                    <td>
                                                        <a href="admin/6-payment-receipt-view.php"><i
                                                                class="c-icon c-icon-1xl mb-2 cil-search"></i></a>
                                                        &nbsp;

                                                        <a href="admin/6-payment-receipt-edit.php"><i
