...
<head>
    ...
    <title>Sales Quote Entry - <?=GLOBAL_TITLE;?></title>
                                    ...
                                    <div class="card-header">
                                        <div class="row">
                                            <div class="col-lg-10 col-sm-10 col-xs-12">
                                                ...
                                                <h5>Sales Quote Entry</h5>
                                            </div>
                                            <div class="col-lg-2 col-sm-2 col-12">
                                                <a href="admin/9-sales-quote-entry-add.php" class="btn btn-sm btn-info"
                                        ...
                                        <table class="table table-responsive-sm table-bordered table-striped table-sm"
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>10-08-2022</td>
                                                    <td>
                                                        <a href="admin/9-sales-quote-entry-view.php"><i
                                                                class="c-icon c-icon-1xl mb-2 cil-search"></i></a>
                                                        &nbsp;
                                                        <a href="admin/9-sales-quote-entry-edit.php"><i
