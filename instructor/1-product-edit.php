                            ...
                            <div class="col-sm-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="form-group col-sm-6">
                                                <label for="Product-Type" class="required">Product Type</label>
                                                <input class="form-control" id="Product-Type" type="text" value="Cloth">
                                            </div>
                                            <div class="form-group col-sm-6">
                                                <label for="Product-Code" class="required">Product Code</label>
                                                <input class="form-control" id="Product-Code" type="text" value="SCR01">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="form-group col-sm-6">
                                                ...
                                                <input class="form-control" id="Product-Name" type="text" value="Scrap">
                                            </div>
                                            <div class="form-group col-sm-6">
                                        ...
                                        <div class="row">
                                            <div class="form-group col-sm-6">
                                                <label for="Baseline-Price">Baseline Price (Rs.)</label>
                                                <input class="form-control" id="Baseline-Price" type="text" value="40">
                                            </div>
                                            <div class="form-group col-sm-6">
                                    ...
                                    <ul class="bottom-buttons">
                                        ...
                                        <li><a href="admin/1-product-list.php"><button class="btn btn-info"
                                                    type="button"
