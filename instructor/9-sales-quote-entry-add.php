...
<head>
    ...
    <title>Add Sales Quote Entry - <?=GLOBAL_TITLE;?></title>
                                       ...
                                       <div class="row">
                                            ...
                                            <div class="form-group col-sm-4">
                                                ...
                                                <select class="form-control" name="cars" id="cars">
                                                    ...
                                                    <option value="GGM" selected>GGM</option>
                                        ...
                                        <div class="row">
                                            <div class="form-group col-sm-3">
                                                ...
                                                <select class="form-control" name="cars" id="cars">
                                                    <option value="">Please Select</option>
                                                    <option value="PRO01" selected>PRO01</option>
                                                    <option value="PRO02">PRO02</option>
                                                    <option value="PRO03">PRO03</option>
                                                    <option value="PRO04">PRO04</option>
                                                </select>
                                            </div>
                                            <div class="form-group col-sm-3">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="type-details form-group col-sm-12">
                                                ...
                                                <button class="btn btn btn-info add" style="float:right; margin-bottom: 14px;">+</button>
                                                <p><strong>Customer Details</strong></p>
                                                    ...
                                                    <tr class="participantRow">
                                                        ...
                                                        <td><button class="btn btn-sm btn-danger remove" type="button">Remove</button></td>
                                                      </tr>
                                                    <tr id="addButtonRow">
                                                    </tr>
                                            </table>
