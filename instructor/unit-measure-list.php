...
<head>
    ...
    <title>Unit Measure - <?=GLOBAL_TITLE;?></title>
                                    ...
                                    <div class="card-header">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-1 col-sm-1 col-2">
                                                <a href="admin/unit-measure-add.php" style="float:right;"><button
                                                        class="btn btn-sm btn-info" type="button">Add</button>
                                                </a></span>
                                            </div>
                                            <div class="col-lg-1 col-sm-1 col-2">
                                                &nbsp;
                                        ...
                                        <table class="table table-responsive-sm table-bordered table-striped table-sm"
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <!-- <a href="admin/unit-measure-view.php"><i
                                                                class="c-icon c-icon-1xl mb-2 cil-search"></i></a>
                                                        &nbsp; -->

                                                        <a href="admin/unit-measure-edit.php"><i
                                                ...
                                                <!-- <tr>
                                                    ...
                                                    <td>30</td>
                                                    <td>
                                                        <a href="admin/1-product-view.php"><i
                                                                class="c-icon c-icon-1xl mb-2 cil-search"></i></a>
                                                        &nbsp;

                                                        <a href="admin/1-product-edit.php"><i
                                                                class="c-icon c-icon-1xl mb-2 cil-pencil"
                                                                style="color: blue;"></i></a> &nbsp;
